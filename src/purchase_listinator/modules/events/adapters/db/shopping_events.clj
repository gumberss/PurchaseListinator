(ns purchase-listinator.modules.events.adapters.db.shopping-events
  (:require
    ...
    [schema.core :as s]
    [purchase-listinator.modules.events.schemas.wires.out.db.shopping-cart-events :as wires.out.db.shopping-cart-events]
    [purchase-listinator.modules.events.schemas.models.shopping-events :as models.shopping-event]
    [purchase-listinator.misc.general :as misc.general]))

(s/defn internal->db :- wires.out.db.shopping-cart-events/ShoppingCartEvent
...
(s/defn db->internal :- models.shopping-event/ShoppingEvent
  [{:shopping-event/keys [category-id item-id properties] :as event} :- wires.out.db.shopping-cart-events/ShoppingCartEventDb]
